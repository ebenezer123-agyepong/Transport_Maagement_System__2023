...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 22, 2023 at 01:18 AM
...
(4, 'Ebenezer', 'Agyapong', '0242820318', 'ws-242-45', 'User', 'eben@gmail.com', 'eben1', '', '', '', ''),
(5, 'Elizabeth', 'Agyapong', '0548168363', 'WS-465-90', 'User', '054816836a@gmail.com', 'eliza1', '', '', '', ''),
(6, 'Eliza', 'Agya', '0765432456', 'WS-465-96', 'User', 'liza@gmail.com', 'liza1', '', '', '', ''),
(7, 'John', 'Agyapong', '0548168368', 'ws-242-45', 'User', 'John@gmail.com', 'john', '', '', '', ''),
(8, 'Ebenezer', 'Agyapongs', '0242820314', 'WS-465-96', 'Driver', 'ebenagya@gnail.com', 'driver', 'Bus', 'GA-456-20', '', 'Pending');
...
(3, 'Akuffo Bus', 'GA-456-20', '50', 'Esther Ngundo', 'Bus', '', 'Available'),
(4, 'The Punisher', 'KCG 215 A', '40', 'Esther Ansah', 'Bus', '', 'Booked'),
(5, 'TGOD', 'KAV 466P', '14', '', 'Bus', '', 'Booked'),
(6, 'Saloon Car', 'KBZ 120T', '7', 'Esther Ngundo', 'Saloon Cars', 'maxresdefault.jpg', 'Available');
...
INSERT INTO `userlog` (`log_id`, `u_id`, `u_email`, `u_ip`, `u_city`, `u_country`, `log_date`) VALUES
(1, 8, 'ebenagya@gnail.com', '::1', 'Unknown', 'Unknown', '0000-00-00 00:00:00');
...
--
ALTER TABLE `tms_vehicle`
  MODIFY `v_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
